...
var Container = function(modules, parent) {
  parent = parent || {
    get: function(name) {
  ...
  var self = instances.$container = instances.container = this;
  ...
  var createChild = function(modules, forceNewInstances) {
    ...
    return new Container(modules, self);
  };
  ...
  function processModule(module) {
    ...
    if (module instanceof Module) {
      ...
      if (module.__exports__) {
        ...
        var privateInjector = new Container((module.__modules__ || []).concat([clonedModule]), self);
